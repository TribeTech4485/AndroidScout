...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(pairedDevices.size() > 0)
        {
            ...
            {
                //device.getAddress().equals("00:1A:7D:DA:71:13")
                if(device.getName().equals("raspberrypi") || device.getAddress().equals("B8:27:EB:F9:A0:15")) //Note, you will need to change this to match the name of your device
                {
